...
public class Chatbot {
    ...
    public static String doCommand(String strInput) {
        ...
        if(strInput.toLowerCase().contains("animal") || strInput.toLowerCase().contains("bathroom") || strInput.toLowerCase().contains("contact")) {
            recognized = true;
        }
        if (strInput.toLowerCase().contains("animal") ) {
            animal = true;
